class AddDefaultTables < ActiveRecord::Migration
  def change
    ...
    create_table "adminhistory" do |t|
    ...
    create_table "computers" do |t|
      t.float   "posX",      limit: 10, null: false
      t.float   "posY",      limit: 10, null: false
      t.float   "posZ",      limit: 10, null: false
      t.float   "rotX",      limit: 10, null: false
      t.float   "rotY",      limit: 10, null: false
      t.float   "rotZ",      limit: 10, null: false
    ...
    create_table "don_transaction_failed" do |t|
      t.text   "output",            null: false
      t.string "ip",     limit: 30
    end

    create_table "don_transactions" do |t|
    ...
    add_index :friends, ["id", "friend"], :unique => true

    create_table "fuelpeds" do |t|
    ...
    create_table "items", primary_key: "index" do |t|
      t.integer "type",      limit: 1, null: false
    ...
    create_table "objects" do |t|
      ...
      t.float   "posX",        limit: 12, default: 0.0, null: false
      t.float   "posY",        limit: 12, default: 0.0, null: false
      t.float   "posZ",        limit: 12, default: 0.0, null: false
      t.float   "rotX",        limit: 12, default: 0.0, null: false
      t.float   "rotY",        limit: 12, default: 0.0, null: false
      t.float   "rotZ",        limit: 12, default: 0.0, null: false
      t.integer "interior",                             null: false
      t.integer "dimension",                            null: false
    ...
    create_table "phone_contacts", id: false do |t|
      t.integer "phone",                  null: false
      t.string  "entryName",   limit: 30, null: false
      t.integer "entryNumber",            null: false
    end

    create_table "phone_settings", primary_key: "phonenumber" do |t|
    ...
    create_table "publicphones" do |t|
      t.float   "x",         null: false
      t.float   "y",         null: false
      t.float   "z",         null: false
      t.integer "dimension", null: false
    ...
    create_table "speedcams" do |t|
      t.float   "x",         limit: 11, default: 0.0, null: false
      t.float   "y",         limit: 11, default: 0.0, null: false
      t.float   "z",         limit: 11, default: 0.0, null: false
    ...
    create_table "speedingviolations" do |t|
    ...
    create_table "suspectcrime" do |t|
      t.text    "suspect_name"
      t.text    "time"
      t.text    "date"
      t.text    "officers"
    ...
    create_table "suspectdetails" do |t|
      t.text    "suspect_name"
      t.text    "birth"
      t.text    "gender"
      t.text    "ethnicy"
    ...
    create_table "wiretransfers" do |t|
